...
class UsersController extends Controller
{
    ...
    public function sendPush (Request $request)
    {
        ...
        return redirect()->action('UsersController@index')->with('doneMessage', 'Notification sent!');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->action('UsersController@index')->with('doneMessage', __('backend.addDone'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($User)) {
            ...
            $User->save();
            return redirect()->action('UsersController@edit', $id)->with('doneMessage', __('backend.saveDone'));
        } else {
            return redirect()->action('UsersController@index');
        }
    }
    ...
    public function destroy($id)
    {
        ...
        if (!empty($User) && $id != 1) {
            ...
            $User->delete();
            return redirect()->action('UsersController@index')->with('doneMessage', __('backend.deleteDone'));
        } else {
            return redirect()->action('UsersController@index');
        }
    }
    ...
    public function updateAll(Request $request)
    {
        ...
        return redirect()->action('UsersController@index')->with('doneMessage', __('backend.saveDone'));
    }
