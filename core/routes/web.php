...
Route::Group(['prefix' => env('BACKEND_PATH'), 'middleware' => ['auth']], function () {
    ...
    Route::post('/webmaster/languages/store', 'WebmasterSettingsController@language_store')->name('webmasterLanguageStore');
    Route::post('/webmaster/languages/store', 'WebmasterSettingsController@language_store')->name('webmasterLanguageStore');
    Route::post('/webmaster/languages/update', 'WebmasterSettingsController@language_update')->name('webmasterLanguageUpdate');
    Route::get('/webmaster/languages/destroy/{id}', 'WebmasterSettingsController@language_destroy')->name('webmasterLanguageDestroy');
    Route::get('/webmaster/seo/repair', 'WebmasterSettingsController@seo_repair')->name('webmasterSEORepair');
    ...
    Route::get('/cache-clear', function () {
        ...
        return redirect()->route('adminHome')->with('doneMessage', __('backend.cashClearDone'));
    })->name('cacheClear');
});
...
Route::get('/doc-epub/bibi/?book=15883330424414.epub', 'FrontendHomeController@topicBibi')->name('FileBibi');
